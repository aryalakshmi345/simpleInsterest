...
function App() {
  ...
  const [isPrincipleValid,setIsPricipleValid] = useState(true)
  ...
  return (
    <div style={{height: '100vh'}} className='d-flex align-items-center justify-content-center w-100 bg-dark'>
     <div style={{width:'500px'}} className='bg-light p-5 rounded'>
       <h3>Simple Interest App</h3>
       <p>Calculate your simple interest</p>
       <div className='interest-card w-100 bg-warning mt-5 d-flex justify-content-center align-items-center flex-column text-light rounded shadow' style={{height:'150px'}}>
          <h1> ₹ {''} {interest}</h1>
